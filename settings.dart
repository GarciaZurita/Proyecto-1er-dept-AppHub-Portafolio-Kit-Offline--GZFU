...
class SettingsPage extends StatelessWidget {
  // Widget inmutable (StatelessWidget) para la pantalla de ajustes
      ...
      body: ListView(
        ...
        children: [
          ValueListenableBuilder<ThemeMode>(
            ...
            builder: (context, mode, _) {
              ...
              return SwitchListTile(
                ...
                // El switch está activado si el tema actual es oscuro
                onChanged: (v) =>
          ...
          ListTile(
            ...
            subtitle: const Text('v1.0 — Autor: Garcia Zurita'),
