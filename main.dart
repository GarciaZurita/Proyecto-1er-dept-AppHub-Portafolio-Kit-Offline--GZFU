...
// Importa todas las pantallas de la app: Hub, índice de prácticas, prácticas individuales, módulo Kit Offline y ajustes

/// Notifier global para el ThemeMode (estado en memoria)
final ValueNotifier<ThemeMode> appTheme = ValueNotifier(ThemeMode.light);
// Crea un ValueNotifier que controla el tema claro/oscuro de la app
// Permite cambiar el tema en tiempo real desde cualquier pantalla
    ...
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, mode, _) {
        ...
        return MaterialApp(
          ...
          initialRoute: '/',
          // Ruta inicial al arrancar la app (Hub)
          routes: {
